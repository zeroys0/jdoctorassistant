...
//	private int mFlingableValue = FLINGABLE_VALUE;
	...
	private int mMenuItemLayoutId = R.layout.view_circle_layout_item;
	...
	private void addMenuItems()
	{
		...
		for (int i = 0; i < mMenuItemCount; i++)
		{
			...
			ImageView igv = (ImageView) view
					.findViewById(R.id.circle_layout_item_igv);
			TextView tv = (TextView) view
					.findViewById(R.id.circle_layout_item_tv);

			if (igv != null)
			{
				igv.setVisibility(View.VISIBLE);
				igv.setImageResource(mItemImgs[i]);
				igv.setOnClickListener(new OnClickListener()
				{
					@Override
					public void onClick(View v)
					{
