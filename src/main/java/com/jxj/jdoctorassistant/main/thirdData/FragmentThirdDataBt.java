 ...
 */
public class FragmentThirdDataBt extends Fragment {
    @Bind(R.id.third_data_bt_lv)
    ListView lv;

    private JAssistantAPIThread getThirdDataThread;
    private Context context;
    private ThirdDataBtAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_third_data_bt, container, false);
        ButterKnife.bind(this,view);

        context=getActivity();

        adapter=new ThirdDataBtAdapter(context);
