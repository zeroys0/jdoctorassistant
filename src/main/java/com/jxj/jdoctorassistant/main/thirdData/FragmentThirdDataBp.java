...
import com.jxj.jdoctorassistant.adapter.thirdData.ThirdDataBpAdapter;
...
public class FragmentThirdDataBp extends Fragment {
    @Bind(R.id.third_data_bp_lv)
    ListView lv;

    private JAssistantAPIThread getThirdDataThread;
    private ThirdDataBpAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_third_data_bp, container, false);
        ButterKnife.bind(this,view);

        context=getActivity();

        adapter=new ThirdDataBpAdapter(context);
