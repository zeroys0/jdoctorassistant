...
public class DiseaseInfoAdapter extends RecyclerView.Adapter<DiseaseInfoAdapter.ViewHolder> {
    ...
    public DiseaseInfoAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v=inflater.inflate(R.layout.rv_item_disease_info,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv.setText(object.getString("description"));
...
//            igv=(ImageView) itemView.findViewById(R.id.disease_class_igv);
            tv=(TextView) itemView.findViewById(R.id.disease_info_tv);
