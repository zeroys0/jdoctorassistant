 ...
 */
public class Department1Adapter extends RecyclerView.Adapter<Department1Adapter.ViewHolder> {
    ...
    public Department1Adapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v=inflater.inflate(R.layout.rv_item_department_1,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(holder.getPosition()== DepartmentListActivity.SELECTPOSITION){
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            super(itemView);
            bgLL=(LinearLayout)itemView.findViewById(R.id.department_1_ll);
            tv=(TextView) itemView.findViewById(R.id.department_1_tv);
        }
    }
}
