...
public class DownloadImageThread extends Thread {
	...
	String key = null;
	String methodName = ApiConstant.DOWNLOADIMAGE;
	String result = null;
...
//		key = ApiConstant.KEY;
		...
		System.out.println("iprecareWebService  downloadimage  localSoapObject:"
	...
	public String getResult() {
		System.out.println("公用 接口： "+methodName + "_result:" + result+" image: "+image);
		return result;
	}
}
