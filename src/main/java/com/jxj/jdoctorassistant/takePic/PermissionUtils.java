...
//        }
        ...
        try {   // 检查是否缺少某个权限
            ...
            Toast.makeText(activity, "请打开这个权限", Toast.LENGTH_SHORT)
                    .show();
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission)) {
                ...
                shouldShowRationale(activity, requestCode, requestPermission);    // 弹出提示信息(理由)
            ...
            permissionGrant.onPermissionGranted(requestCode);    // 通过接口回调，通知以获取权限
        }
    }
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
           /* Toast.makeText(activity, "all permission success" + notGranted, Toast.LENGTH_SHORT)
            ...
            openSettingActivity(activity, "某些功能需要您去授权");
        }
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "某些功能需要您去授权",
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode < 0 || requestCode >= requestPermissions.length) {
            ...
            Toast.makeText(activity, "非法结果码：illegal requestCode:" + requestCode, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    /**
     * 申请多个权限时，判断申请过的则不需要再次申请，返回需要申请的即可
     *
     * @param activity
